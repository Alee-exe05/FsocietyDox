...
import { chartData, chartConfig } from '@/lib/data/modules';
import { ModerationTool } from './components/dashboard/moderation-tool';
      ...
      <main className="flex-1">
        ...
        <div className="px-4 md:px-10 pb-4 md:pb-10 space-y-8">
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <StatCard title={dictionary.dashboard.stats.users} value="2" icon={Users} />
